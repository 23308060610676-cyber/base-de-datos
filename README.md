...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2026 a las 17:12:57
...
CREATE TABLE `id_usuario` (
  ...
  `ultimo acceso` timestamp(6) NULL DEFAULT NULL,
  ...
  `fecha limite` date NOT NULL,
  `hora limite` time NOT NULL
...
ALTER TABLE `id_usuario`
  ADD PRIMARY KEY (`nombre`,`id_tareas`);
COMMIT;
